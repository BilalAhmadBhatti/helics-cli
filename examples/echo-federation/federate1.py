...
for t in range(5, 10):
    ...
    h.helicsPublicationPublishDouble(pub, val+currenttime)
    print(f"{federate_name}: Sending value pi = {val+currenttime} at time {currenttime}")
